...
habits. It will overall make you a better coder, producing better quality code, and avoiding
...
tooling: **linting**, **formating**, **type checking**. You will also have **poetry** to handle your
